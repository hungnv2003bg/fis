...
const Step1 = ({endStep, visible}: IProps) => {
  ...
  const [yearOfBirth, setYearOfBirth] = useState<number>(year - 13);
  const [inPersonCourseInterest, setInPersonCourseInterest] = useState<boolean>(false);
  const [onlineCourseInterest, setOnlineCourseInterest] = useState<boolean>(false);
  ...
  const onInPersonCourseInterestChange = (e: BaseSyntheticEvent) => {
    setInPersonCourseInterest(e.target.checked);
  }

  const onOnlineCourseInterestChange = (e: BaseSyntheticEvent) => {
    setOnlineCourseInterest(e.target.checked);
  }
  ...
  const end = () => {
    const data: Step1Data = {
      ...
      firstName: firstName,
      inPersonCourseInterest: inPersonCourseInterest,
      onlineCourseInterest: onlineCourseInterest,
      password: password,
  ...
  return (
    <div className={`step${visible ? "" : " hidden"}`}>
      <div className="left">
        <div className="row">
          <div className="col">
            <label>* Your family name and first name</label>
        ...
        <hr/>
        <div className="row">
          <div className="title">Your address (so we can suggest classes near you)</div>
        </div>
        <div className="row">
          <div className="col">
            <label>City</label>
        ...
        <div className="row">
          <div className="col inline">
            <input type="checkbox" checked={onlineCourseInterest} onChange={onOnlineCourseInterestChange}/>
            <label>Online Courses</label>
          </div>
          <div className="col inline">
            <input type="checkbox" checked={inPersonCourseInterest} onChange={onInPersonCourseInterestChange}/>
